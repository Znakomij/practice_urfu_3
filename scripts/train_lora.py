...
dataset = dataset.map(
    ...
    batched=True,
    cache_file_names={
        "train": "./cache/datasets_train",
        "test": "./cache/datasets_test",
        "validation": "./cache/datasets_val",
    },
)
...
# видеопамяти. Значение batch_size=16 для тренировочной выборки было
# подобрано для NVidia RTX 4070Ti с 12 Гб видеопамяти. На этой карте
# проводилось обучение модели.
train_dataloader = DataLoader(
    dataset["train"], shuffle=True, batch_size=16, num_workers=9
)
